...
public class AdvanceWXPayController {
    ...
    public String pay(@RequestParam(required = false) String code, Integer orderId, Model model, HttpServletRequest request) {
        try {
            ...
            UnifiedOrderResData unifiedOrder = unifiedOrderHandler.unifiedOrder(notifyUrl, advanceTransfer.getOut_trade_no(), advanceTransfer.getAdvance() - advanceTransfer.getUseVoucher(), payConfig, agent, "和之初生物科技置换券充值");
