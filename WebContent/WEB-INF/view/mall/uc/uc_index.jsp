...
<jsp:include page="/WEB-INF/view/mall/mall_menu.jsp"></jsp:include>
	...
	<%-- 	<div class="row">
		...
		<div class="row">
			<div class="col-xs-12">
				<a class="btn btn-success btn-block btn-lg" href="<c:url value='/stats/market/index.html?agentCode=${user.agentCode}'/>" id="sw">
					<span class="fa fa-truck"></span>市场情况
				</a>
			</div>
		</div>
		<br>
		...
		<div class="row">
			<div class="col-xs-12">
				<a class="btn btn-info btn-block btn-lg" href="<c:url value='/transfer/my.html'/>" id="sw">
					<span class="glyphicon glyphicon-usd"></span>&nbsp我要转货
				</a>
			</div>
		</div>
		<br>
	...
	<%--<div class="row">--%>
		<%--<div class="col-xs-12">--%>
			<%--<a class="btn btn-info btn-block btn-lg" href="<c:url value='/advance/pay/index.html'/>" id="sw">--%>
				<%--<span class="glyphicon glyphicon-usd"></span>&nbsp置换券充值--%>
			<%--</a>--%>
		<%--</div>--%>
	<%--</div>--%>
	<%--<br>--%>
<%--</c:if>--%>
		...
		--%>
			...
			<div class="col-xs-12">
				<a class="btn btn-warning btn-block btn-lg" href="<c:url value='/transfer/records.html?from=${user.id}'/>" id="sw">
					<span class="glyphicon glyphicon-plane"></span>&nbsp转货记录
				</a>
			</div>
		</div>
		<br> 
		...
		<!--我的 -->
			...
			<div class="col-xs-12">
				<a class="btn btn-warning btn-block btn-lg" href="<c:url value='/delivery/index.html'/>" id="sw">
					<span class="glyphicon glyphicon-plane"></span>&nbsp发货记录
				</a>
			</div>
		</div>
		<br>
		...
		<div class="row">
			<div class="col-xs-12">
				<a class="btn btn-warning btn-block btn-lg" href="<c:url value='/advance/my.html'/>" id="sw">
					<span class="glyphicon glyphicon-plane"></span>&nbsp转置换券
				</a>
			</div>
		</div>
		<br>
		...
		<%--<c:if test="${vip}">--%>
			<%--<div class="row">--%>
				<%--<div class="col-xs-12">--%>
					<%--<a class="btn btn-primary btn-block btn-lg" href="<c:url value='/voucher/record.html'/>" id="sw">--%>
						<%--<span class="fa fa-desktop"></span>置换券详情--%>
					<%--</a>--%>
				<%--</div>--%>
			<%--</div>--%>
			<%--<br>--%>
