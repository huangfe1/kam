...
<header
    ...
    <div id="myCarousel" class="carousel slide ">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <img src="<c:url value='/resources/images/header1.jpg'/>" alt="广告3">
            </div>
        </div>
...
<div class="container" id="nav">
    <div class="row">
        ...
        <div class="col-xs-3">
            <a class="thumbnail" href="<c:url value='/agent/myAuth.html?from=${user.id}'/>"> <img data-src="" alt=""
                                                                                                  src="<c:url value='/resources/images/tuiguang.jpg'/>"
                                                                                                  data-holder-rendered="true">
                <div class="caption">
                    <h6 class="text-center">我的账户</h6>
                </div>
            </a>
        </div>
        ...
        <c:if test="${user !=null}">
            <div class="col-xs-3">
                <a class="thumbnail"
                   href="<c:url value='/vmall/uc/dmz/promoCode.html/${user.agentCode}'/>"> <img
                        data-src="" alt=""
                        src="<c:url value='/resources/images/tuiguang.jpg'/>"
                        data-holder-rendered="true">
                    <div class="caption">
                        <h6 class="text-center">我的推广</h6>
                    </div>
                </a>
            </div>
        </c:if>
    ...
    <span style="color:red;font-size: 1.2em">精彩推荐:</span><span
        style="color: #00aba9;margin-left: 2em">咖盟一站式购物平台,赶紧抢购!!!</span>
</div>
