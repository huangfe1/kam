			...
			<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
				...
				<c:if test="${agentCode!=null}">
					<form role="form" action="<c:url value='/vmall/uc/dmz/${agentCode}/register.json' />"
						...
						<div class="form-group">
							<label for="remittance" class="control-label">申请的级别</label>
							<div class="row">
								<div class="col-md-8 col-xs-12 input-group">
									<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
									<input type="text" class="form-control input-lg" id="remittance"
										   tabIndex="10" required name="remittance" autofocus="autofocus"
										   value="${parameter.entity.remittance}" placeholder="填写您要申请的级别,如:眼护士">
								</div>
								<div class="col-md-4 col-xs-4 text-error"></div>
							</div>
						</div>
								...
								$(form).ajaxSubmit(
												{beforeSubmit : function() {
													...
													success : function(
														...
														if (m.flag == "0") {
															$("#alertMessageBody").empty().html("注册成功,通知管理员审核");
