...
<nav class="navbar navbar-inverse navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		...
		<p class="navbar-text">咖盟管理信息系统</p>
	</div>
	<!-- /.navbar-header -->
	<div class="collapse navbar-collapse menu-navbar-collapse" id="menu-navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<c:when test="${user.agent}">
					...
					<%--<li><p class="navbar-text">置换券:<span id="advanceBalance">${accounts.advanceBalance}</span></p></li>--%>
				...
				<%--<c:when test="${user.admin}">--%>
                    ...
                    <%--<li><p class="navbar-text">公司账户置换券余额:<span id="advanceBalance">${accounts.advanceBalance}</span></p></li>--%>
                <%--</c:when>--%>
				</c:choose>
			</ul>
				...
				<c:if test="${user.agent}">
					<li><a href="#" class="menuitem"><i
						...
						<ul class="nav nav-second-level">
							...
							<i class="fa fa-users fa-fw"></i>我的客户<span class="fa arrow"></span></a></li>
							<li><a href="<c:url value='/stats/market/index.html?agentCode=${user.agentCode}'/>">
								<i class="fa fa-users fa-fw"></i>市场情况<span class="fa arrow"></span></a></li>
