							...
							<div class="form-group">
								...
								<div class="col-md-4 col-xs-4 text-error"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
										<input type="text"  <c:if test="${toback eq 1}"> readonly='readonly' value="咖盟"</c:if> name="userByToAgent.realName" class="form-control" id="esditName" tabIndex="12" required placeholder="输入对方姓名">
										</div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
									<div class="form-group">
