									...
									<tbody id="accounts">
										<c:forEach items="${parameter.entity.goodsAccounts}"
											...
											<tr>
												...
												<td><select class="form-control priceLevel" <c:if test="${user.agent&&!user.vip}"> readonly="readonly"
												...
												<c:forEach items="${accounts.goods.prices}" var="priceLevel">
													<option   <c:if test="${!user.admin&&priceLevel.agentLevel.id eq 53}">disabled="disabled"</c:if>  value="${priceLevel.agentLevel.id}"
