		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title text-primary" id="myModalLabel">
					<span class="glyphicon glyphicon-retweet"></span>代理置换券转账</h4>
			</div>
						...
						<div class="col-md-12 col-xs-12">
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" required autofocus="autofocus"
												   ...
												   value="咖盟" placeholder="请输入置换券接受人姓名">
									...
									<div class="form-group">
										<label for="currentStock" class="col-sm-2 control-label">转出置换券数量</label>
										<div class="col-sm-4">
											<input type="number" class="form-control input-lg" required
												   id="editPoint" tabIndex="12" name="advance" value=""
												   placeholder="输入转出数量">
									...
									<div class="form-group">
										...
										<div class="col-sm-6 col-xs-12">
											<textarea class="form-control" rows="4" name="remark" tabindex="13">公司转出置换券</textarea>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-xs-12">
							<button type="submit" class="btn btn-success btn-block"
								...
								<span class="glyphicon glyphicon-random">&nbsp;</span>转置换券给代理
							</button>
						</div>
					</div>
				</div>
