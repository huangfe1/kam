	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<div class="container-fluid">
				<div class="row">
					<form action="<c:url value='/pmall/shopcart/payByAdvance.json'/>" name="editForm"
                        ...
                        <div id="selectDiv" style="display: none">
                            ...
                            <c:forEach var="address" items="${user.addresses}" varStatus="sta">
                                ...
                                <div class="panel-body">
                                    <div class="row ">
                                        <div class="col-md-3 col-xs-6">收货人:&nbsp&nbsp<span class="name">${address.consignee}</span><span class="code">${address.consigneeCode}</span></div>
                                        <div class="col-md-9 col-xs-6" style="text-align: right"><span class="mobile">${address.mobile}</span></div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-md-12 col-xs-12">收货地址:&nbsp&nbsp<span class="province">${address.province}</span><span class="city">${address.city}</span><span class="country">${address.country}</span><span class="address">${address.address}</span></div>
                                    </div>
                                </div>
                        </div>
                        ...
                        <!--地址修改层-->
                    <c:if test="${!empty user.addresses&&address.status==null}">
                            <div id="editPanel" class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="row ">
                                        <div class="col-md-3 col-xs-6">收货人:&nbsp&nbsp<span class="name">XX</span><span class="code">XX</span></div>
                                        <div class="col-md-9 col-xs-6" style="text-align: right"><span class="mobile">XX</span></div>
                                    </div>
                                    <div class="row ">
                                        <div class="col-md-12 col-xs-12">收货地址:&nbsp&nbsp<span class="province">XX</span><span class="city">XX</span><span class="country">XX</span><span class="address">XX</span></div>
                                    </div>
                                </div>
                            </div>
                    </c:if>
                        ...
                        >
							...
							<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="editAgentCode"
												tabIndex="10" name="consigneeCode"
									...
									<div class="form-group">
										...
										<div class="col-sm-3"><label class="col-sm-2 control-label">省</label><select val="${address.province}" type="text" class="form-control" id="s_province" name="province"></select></div>
                                        <div class="col-sm-3"> <label class="col-sm-2 control-label">市</label><select val="${address.city}" type="text" class="form-control" id="s_city" name="city" ></select></div>
                                        <div class="col-sm-3"><label class="col-sm-2 control-label">县</label><select val="${address.country}" type="text" class="form-control" id="s_county" name="country"></select></div>
										<div class="col-md-4 col-xs-4 text-error"></div>
									</div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
											<textarea rows="3" class="form-control" id="editRemark"
                                                      ...
                                                      value="${parameter.entity.remark}" placeholder="请输入发货备注信息">${address.remark}</textarea>
...
<script type="text/javascript">
	...
	function init() {
        ...
        $(".selectPanel").click(function(e){
            ...
            //设置区
            $("#s_country").val($(this).find(".country").html());
