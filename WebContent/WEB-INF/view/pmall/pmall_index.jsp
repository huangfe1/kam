...
<%--<header--%>
    ...
    <%--&lt;%&ndash;<img src="<c:url value='/resources/images/pmall_header.jpg'/>"&ndash;%&gt;--%>
    <%--&lt;%&ndash;class="header-img">&ndash;%&gt;--%>
    <%--&lt;%&ndash; <p class="header-title">${owner}的小店</p> &ndash;%&gt;--%>
    <%--&lt;%&ndash; <img src="<c:url value='/resources/images/mall-logo.jpg'/>"--%>
        <%--class="logo-img"> &ndash;%&gt;--%>
...
<div class="container" id="nav">
    <div class="row">
        ...
        <div class="col-xs-4">
            <a class="thumbnail"
               href="<c:url value='/mall/index.html'/>"
            > <img data-src="" alt=""
                   src="<c:url value='/resources/images/tuiguang.jpg'/>"
                   data-holder-rendered="true">
                <div class="caption">
    ...
    <h6 style='font-family: "Microsoft Yahei", STXihei,
        ...
        <c:if test="${empty account_points }">
            <h6><span id="pointsTotal">登录后可查看置换券</span></h6>
        </c:if>
        <c:if test="${not empty account_points}">
        <%--您有<span id="pointsTotal"><strong>${account_points}</strong>置换券</span></h6>--%>
    </c:if>
</div>
