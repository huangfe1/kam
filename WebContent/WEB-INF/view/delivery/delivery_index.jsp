			...
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left" id="searchForm"
					...
					<div class="form-group">
						...
						<label class="">申请发货人编号</label> <input type="text"
															 value="${parameter.entity.userByApplyAgent.agentCode}" name="entity.userByApplyAgent.agentCode" id="applyAgentCode"
						...
						<c:forEach items="${dls}" var="g">
							<tr data-row="${g.id}">
								...
								<td>
									...
									<a class="btn btn-warning " href="<c:url value='/securityCode/scan_num.html?owner=${g.userByConsignee.realName}&&agentCode=${g.userByConsignee.agentCode}' /> ">录防伪</a>
								</td>
							</tr>
						</c:forEach>
						</tbody>
